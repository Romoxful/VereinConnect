<svelte:head>
	<title>Datenschutzerklärung - Förderverein FF</title>
</svelte:head>
	...
	<div class="space-y-6 text-sm leading-relaxed text-gray-700 dark:text-slate-300">
		...
		<section>
			...
			<ul class="ml-6 mt-2 list-disc space-y-1">
				...
				<li>Telefonnummer</li>
				<li>Eintrittsdatum und Mitgliedsstatus</li>
				<li>Beitragszahlungen und Zahlungsstatus</li>
			</ul>
		</section>
		...
		<section>
			...
			<ul class="ml-6 mt-2 list-disc space-y-1">
				<li>Art. 6 Abs. 1 lit. b DSGVO — Erfüllung des Mitgliedschaftsvertrags</li>
				<li>Art. 6 Abs. 1 lit. a DSGVO — Einwilligung (z.B. Newsletter, Foto-Freigabe)</li>
				<li>Art. 6 Abs. 1 lit. f DSGVO — Berechtigtes Interesse des Vereins</li>
			</ul>
		</section>
		...
		<section>
			...
			<ul class="ml-6 mt-2 list-disc space-y-1">
				<li><strong>Datenverarbeitung:</strong> Einwilligung in die elektronische Verarbeitung der Mitgliedsdaten</li>
				<li><strong>Newsletter:</strong> Einwilligung zum Empfang von Vereinsnachrichten per E-Mail</li>
				<li><strong>Foto-Freigabe:</strong> Einwilligung zur Veröffentlichung von Fotos bei Vereinsveranstaltungen</li>
			</ul>
			<p class="mt-2">
		...
		<section>
			...
			<p>
				...
				Aufbewahrungsfristen (in der Regel 10 Jahre für steuerrelevante Unterlagen) gespeichert
		...
		<section>
			...
			<ul class="ml-6 mt-2 list-disc space-y-1">
				...
				<li><strong>Datenübertragbarkeit</strong> (Art. 20 DSGVO) — Recht auf Export Ihrer Daten</li>
				<li><strong>Widerspruchsrecht</strong> (Art. 21 DSGVO)</li>
			</ul>
			<p class="mt-2">
				Zur Ausübung Ihrer Rechte wenden Sie sich bitte an den Vorstand.
				Eine Datenexport-Funktion steht im Mitgliederbereich zur Verfügung.
			</p>
		</section>
		...
		<section>
			...
			<ul class="ml-6 mt-2 list-disc space-y-1">
				...
				<li>Verschlüsselte Passwörter (scrypt-Hashing)</li>
				<li>Session-basierte Authentifizierung mit automatischem Ablauf</li>
			</ul>
		</section>
