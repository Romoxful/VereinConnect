	...
	<div class="flex flex-wrap gap-2">
		<div class="inline-flex rounded-lg border border-gray-300 dark:border-slate-600 text-sm">
			<a
				...
				class="rounded-l-lg bg-red-700 px-3 py-2 text-white dark:bg-red-800"
				aria-current="page"
			>
				📋 Liste
			</a>
			<a
				...
				class="rounded-r-lg px-3 py-2 text-gray-700 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-slate-700"
			>
				🗓️ Kalender
			</a>
		</div>
