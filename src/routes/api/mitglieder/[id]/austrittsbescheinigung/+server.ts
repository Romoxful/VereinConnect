...
import { buildResignationCertificate } from '$lib/server/certificates.js';
...
export const GET: RequestHandler = async ({ params, locals }) => {
	...
	const pdf = buildResignationCertificate(member);
	const filename = `austrittsbescheinigung-${member.lastName.toLowerCase()}-${memberId}.pdf`;
